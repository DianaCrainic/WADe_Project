...
const main = async () => {
    const name = "ethereum"; // insert cryptocurrency name
    ...
    const cryptocurrencyId = "http://purl.org/net/bel-epa/doacc#D09fe733c-bb49-4854-a6d2-0c9cf77fa545"; // insert cryptocurrency id
